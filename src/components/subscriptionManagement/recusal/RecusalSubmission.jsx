...
import TechnicalSupportDetailModal from "./RecusalDetailModal";
import {
  useGetRecusalSubmissionsQuery,
  useUpdateRecusalSubmissionMutation,
} from "../../../redux/apiSlices/recusalSubmission";

const { Option } = Select;

const RecusalSubmission = () => {
  // local UI state
  ...
  const {
    ...
    error,
    refetch,
  } = useGetRecusalSubmissionsQuery(queryParams);
    ...
    <div className="">
      ...
      <div className="flex justify-between items-end bg-red-300 p-3 rounded-lg mb-4 mt-4">
        <p className="text-[25px] font-semibold ml-1">
          Juror Recusal & Conflict Declaration Submissiion
        </p>
...
export default RecusalSubmission;
